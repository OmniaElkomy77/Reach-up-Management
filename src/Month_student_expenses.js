...
export default class Month_student_expenses extends Component {
  constructor(props) {
    super(props);
    this.state = {
      money_expenses: [],
        ...
        if (res.status == 200) {
          if (Array.isArray(res.data)) {
            ...
            for (let i = 0; i < res.data.length; i++) {
              if (res.data[i].payment_title == 'Monthly Expenses') {
          ...
          this.state.money_expenses == '' ? (
            ...
            <FlatList
              ...
              renderItem={({item, index}) => (
                <>
                  {/* {item.payment_title == "Mounthly Expenses" ? ( */}
