...
export default class Info extends Component {
    ...
    getMoneyExpenses() {
        ...
        axios.get('https://camp-coding.org/reachUpAcademy/admin/' + 'select_students_payments.php').then((res) => {
                ...
                <View style={styles.HeaderView} >
                    ...
                    <View style={{ width: "75%", flexDirection: "row" }}>
                        ...
                        <View style={{ flex: 2, alignItems: 'center', justifyContent: 'center' }}>
                            <Text style={{ color: '#F5FCFF', fontSize: 17, fontWeight: 'bold' }} >Student Payment</Text>
                        </View>
                    </View>
