            ...
            <>
                ...
                <View style={styles.HeaderView} >
                    ...
                    <View style={{ flex: 2, alignItems: 'center', justifyContent: 'center' }}>
                        <Text style={{ color: '#F5FCFF', fontSize: 17, fontWeight: 'bold' }} >الحسابات</Text>
                    </View>
                        ...
                        <View
...

                            {
                                this.state.Notice != "" ?
                                    ...
                                    :
                                    <Text style={{ alignSelf: "center", width: "70%", fontWeight: "bold", fontSize: 20, alignSelf: "center" }}>لا يوجد ملاحظات</Text>
                        ...
                        <RadioButton.Group
                            ...
                            <View
                                ...
                                <View
                                    ...
                                    <RadioButton value="راتب شهر" />

                                    <Text style={{ fontSize: 18 }}>راتب شهري</Text>
                                </View>
                                ...
                                <View
                                    ...
                                    <Text style={{ fontSize: 18 }}>اخرى</Text>
                                </View>
                            </View>
                        </RadioButton.Group>
