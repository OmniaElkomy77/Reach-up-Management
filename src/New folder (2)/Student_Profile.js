    ...
    UpdateStudentData() {
        ...
        if (this.state.newName.length <= 3 && this.state.newPhone.length <= 0) {
            ...
            if (
                ...
                this.setState({
                    new_Phone_error: "الرجاء كتابه رقم صحيح"
                })
            }
                ...
                <LinearGradient colors={['#3c2365', '#9b8db1']} style={{ flex: 1, padding: "10%" }}>
                    ...
                    <View style={styles.innnerStyle}>
                        ...
                        <Image
                            ...
                            source={require("../constants/images/students_Vector.png")}></Image>
                    </View>
                    {/* </View> */}
                    ...
                    <TouchableOpacity
                        ...
                        <Text style={styles.TextStyle2}>تقرير الطالب</Text>
                    </TouchableOpacity>
                    ...
                    <View style={{ flexDirection: "row", height: "20%", padding: "2%", justifyContent: "center" }}>
                        ...
                        >
                            <Text style={styles.TextStyle2}> تعديل</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
        ...
        <Modal visible={this.state.editModal} transparent={true}>
            <View
                ...
                <View
                    ...
                    <Text style={{ alignSelf: "center", fontSize: 17, color: "#3c2365", fontWeight: "700" }}>تعديل صف و مجموعه الطالب</Text>
                    <View style={{ width: '90%' }}>
                        <Picker
