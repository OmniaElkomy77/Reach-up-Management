                        ...
                        <View style={styles.HeaderView} >
                            <View style={{ width: "60%", flexDirection: "row",paddingLeft:"7%" }}>
                                ...
                                <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                                    <Text style={{ color: '#F5FCFF', fontSize: 17, fontWeight: 'bold' }} >تقرير المجموعه</Text>
                                </View>
                            </View>
                            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                        ...
                        <View style={{
                            ...
                            <View style={{
                                ...
                                <View
                                    ...
                                    <Text style={{ color: "#000", alignSelf: "center" }}>{this.state.Report.teacher_name}</Text>
                                </View>
                        ...
                        <View style={{
                            ...
                            <View style={{
                                ...
                                <View
                                    ...
                                    <Text style={{ color: "#000", alignSelf: "center" }}>{this.state.Report.qs_1_grammer}</Text>
                                </View>
                        ...
                        <View style={{
                            ...
                            <View style={{
                                ...
                                <View
                                    ...
                                    <Text style={{ color: "#000", alignSelf: "center" }}>{this.state.Report.qs_2_dictation}</Text>
                                </View>
                        ...
                        <View style={{
                            ...
                            <View style={{
                                ...
                                <View
                                    ...
                                    <Text style={{ color: "#000", alignSelf: "center" }}>{this.state.Report.qs_3_homework}</Text>
                                </View>
