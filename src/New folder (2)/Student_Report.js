                    ...
                    <ScrollView>
                        ...
                        <View style={styles.HeaderView} >
                            ...
                            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                                <Text style={{ color: '#F5FCFF', fontSize: 17, fontWeight: 'bold' }} >تقرير الطالب</Text>
                            </View>
                            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                                    ...
                                    <View style={{
                                        ...
                                        >
                                            {this.state.Report.participate == "" ?
                                                ...
                                                }}>{this.state.Report.participate}</Text>
                                            }
                                    ...
                                    <View style={{
                                        ...
                                        <View style={{
                                            ...
                                            <View
                                                ...
                                                <Text style={{ color: "#000", alignSelf: "center" }}>{this.state.Report.note}</Text>
                                            </View>
