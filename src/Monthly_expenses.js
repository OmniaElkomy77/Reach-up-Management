            ...
            <>
                ...
                <View style={styles.MainView}>
                    ...
                    <TouchableOpacity style={styles.ContentView}
                        ...
                        onPress={
                            () => {
                                this.setState({ modalVisible: true, month_name: item.item.month_name })
                            }
                        }
                    // onLongPress={() => {
                ...
                <ModalHome
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => {
                            ...
                            this.props.navigation.navigate("Book_expenses", {
                                month_name: this.state.month_name
                            })
                            // alert (this.state.month_name)

                        }}>

                        <Text style={{ fontSize: 20, color: "#000" }}>Book Expenses</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                        style={{
                        ...
                        onPress={() => {
                            ...
                            this.setState({ modalVisible: false });
                            this.props.navigation.navigate("Month_student_expenses",
                                {
                                    month_name: this.state.month_name
                                })
                        ...
                        <Text style={{ fontSize: 20, color: "#000" }}>Month Expenses</Text>
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => {
                            ...
                            this.setState({ modalVisible: false });
                            this.props.navigation.navigate("Another_Expenses",
                            {
                                month_name:this.state.month_name
                            })
                        ...
                        <Text style={{ fontSize: 20, color: "#000" }}>Another Expenses</Text>
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => {
                            ...
                            this.setState({ modalVisible: false });
                            this.props.navigation.navigate("Unpaid_expenses", {
                                month_name: this.state.month_name
                            })
                            // alert (this.state.month_name)
                        ...
                        <Text style={{ fontSize: 20, color: "#000" }}>Unpaid Expenses</Text>
                    </TouchableOpacity>
